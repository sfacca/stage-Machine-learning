...
#structs in julia are now assumed immutable by default
struct MvSkewNormal <: Sampleable{Multivariate, Continuous}
...
#cambiato il modo di definire funzioni con tipo parametrico
function _rand!(dist::MvSkewNormal, out::AbstractVector{T}) where {T<:Real} 
